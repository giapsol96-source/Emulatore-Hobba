    ...
    class ChatCommandRegister
    {
        ...
        internal static void InvokeCommand(ChatCommandHandler commandHandler, int commandID)
        {
            switch (commandID)
            {
                ...
                case 69:
                    {
                        commandHandler.DisconnectClient();
                        break;
                    }
                case 70: 
                    {
                        commandHandler.SetFillMode();
                        break;
                    }
                case 71: 
                    {
                        commandHandler.AllignFurni();
                        break;
                    }
                case 72: 
                    {
                        commandHandler.PlaceAmount();
                        break;
                    }
                case 400:
                    {
                ...
                case 76:
                    {
                        commandHandler.StaffAlert();
                        break;
                    }
                case 77:
                    {
                        commandHandler.redeemhand();
                        break;
                    }
                case 78:
                    {
                        commandHandler.GlobalPixels();
                        break;
                    }
            }
        }
