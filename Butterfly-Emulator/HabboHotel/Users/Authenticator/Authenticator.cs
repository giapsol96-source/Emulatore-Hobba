...
namespace Butterfly.HabboHotel.Users.Authenticator
{
    ...
    {
        internal static Habbo GenerateHabbo(DataRow dRow, DataRow group, string auth_ticket)
        {
            ...
            return new Habbo(id, username, realname, rank, motto, look, gender, credits, activityPoints, activityPointsLastUpdate, isMuted, homeRoom, respect, dailyRespect, dailyPetRespect, mtantPenalty, blockFriends, questID, questProgress, group, achiecvementPoints, auth_ticket);
        }
    }
}
